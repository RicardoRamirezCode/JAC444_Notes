...
public class Rate {
	public static void main(String[] args) {
		...
		for (String key : args) {	// going over elements inside command line arguments
			Integer val = m.get(key);	// getting the key and returning the value
			// if no such key inserted (nothing found above) it will return null
