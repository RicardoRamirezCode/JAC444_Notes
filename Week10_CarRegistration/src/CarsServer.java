	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				// needed since we are using down casting
				cnf.printStackTrace();
			} catch (EOFException eof) {
				// I might be trying to read something from client and might have reached eof
				System.out.println("*** THE client has terminated connection ***");
			} catch (IOException e) {
				// needed as dealing with IO (reading and writing objects)
				e.printStackTrace();
			}
