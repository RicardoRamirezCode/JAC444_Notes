...
public class LabelFrame extends JFrame 
{
   ...
   // note good programming practice to make things that will not change final
   ...
   public LabelFrame()
   {
      ...
      label1.setToolTipText("This is label1");	// what shows(pop ups) when you hover cursor over
